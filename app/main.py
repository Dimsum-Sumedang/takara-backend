...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://takara-demo.vercel.app", "http://localhost:3000"],
...
ALLOWED_ORIGINS = ["https://takara-demo.vercel.app", "http://localhost:3000"]
...
async def add_security_headers(request: Request, call_next):
    ...
    response.headers["Server"] = "Takara-Shield"
    return response
